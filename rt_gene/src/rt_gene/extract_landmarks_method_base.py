...
from rt_gene.src.rt_gene.download_tools import download_external_landmark_models

# noinspection PyUnresolvedReferences
from rt_gene.src.rt_gene import gaze_tools as gaze_tools
from rt_gene.src.rt_gene.SFD.sfd_detector import SFDDetector
from rt_gene.src.rt_gene.ThreeDDFA.ddfa import ToTensorGjz, NormalizeGjz
from rt_gene.src.rt_gene.ThreeDDFA.inference import crop_img, predict_68pts, parse_roi_box_from_bbox, parse_roi_box_from_landmark
from rt_gene.src.rt_gene.tracker_generic import TrackedSubject
...
class LandmarkMethodBase(object):
    ...
    def load_face_landmark_model(self, checkpoint_fp=None):
        import rt_gene.src.rt_gene.ThreeDDFA.mobilenet_v1 as mobilenet_v1
